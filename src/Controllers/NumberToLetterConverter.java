...
public class NumberToLetterConverter {
     ...
     */
    public static String convertNumberToLetter(String number,int moneda)
            throws NumberFormatException {
     ...
     */
    public static String convertNumberToLetter(double doubleNumber,int moneda)
            throws NumberFormatException {
        ...
        simbolos.setPerMill(',');
        DecimalFormat format = new DecimalFormat(patternThreeDecimalPoints,simbolos);
       ...
       if(valor.length()==1){
        ...
        if(moneda==0)converted.append("NUEVOS SOLES");
        else if(moneda==1) converted.append("DÓLARES AMERICANOS");
